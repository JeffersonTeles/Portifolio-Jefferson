...
function Trigger({
  ...
  const handlers = disabled
    ...
    : {
        onPointerEnter: (e) => {
          // !e.buttons also treats missing `buttons` (environments that omit it) as no-button hover.
          if (e.pointerType !== 'touch' && !e.buttons) arm();
        },
        onPointerLeave: (e) => {
        ...
        onPointerDown: (e) => {
          ...
          try {
            ...
            // setPointerCapture is a best-effort enhancement; ignore unsupported browsers.
          }
