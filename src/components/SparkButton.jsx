  ...
  return (
    <>
      {isButton ? (
        ...
        >
          {/* Faísca giratória na borda */}
          <div
            className="absolute inset-0 rounded-xl overflow-hidden"
            style={{
              background: 'conic-gradient(from 0deg, transparent, rgba(226,166,61,0.85), rgba(110,231,183,0.85), rgba(147,197,253,0.85), rgba(226,166,61,0.85), transparent)',
              animation: 'spinBorder 2.5s linear infinite',
            }}
          />
          {/* Camada de proteção semi-transparente */}
          <div
            className="absolute inset-0 rounded-xl bg-surface/90 pointer-events-none"
          />
          {/* Conteúdo do botão */}
