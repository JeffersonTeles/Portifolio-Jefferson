...
const AmbientAudio = () => {
  ...
  useEffect(() => {
    ...
    osc.current.frequency.exponentialRampToValueAtTime(
      targetFreq,
  ...
  return (
    <div className="fixed bottom-8 left-8 z-[100] flex flex-col items-center gap-2 pointer-events-auto">
      <button
        onClick={initAudio}
      ...
      <span className="text-[7px] font-mono text-white/20 uppercase tracking-widest rotate-90 origin-left translate-x-3 mt-4">
        Ambient_Freq
      </span>
    </div>
  );
