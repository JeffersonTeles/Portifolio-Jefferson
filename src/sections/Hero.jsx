    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 pt-20">
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          <a
            href="#contact"
            className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all duration-300 shadow-lg hover:shadow-blue-500/25"
          >
            Iniciar Projeto
          </a>
          <a
            href="#projects"
            className="px-8 py-3 bg-gray-800 hover:bg-gray-700 text-white font-medium rounded-lg transition-all duration-300 border border-gray-700"
          >
            Ver Projetos
          </a>
        </motion.div>
        ...
        >
          ...
          <a href="mailto:jefferson@email.com" className="text-gray-400 hover:text-blue-400 transition-colors">
            <FiMail size={24} />
          </a>
        </motion.div>
