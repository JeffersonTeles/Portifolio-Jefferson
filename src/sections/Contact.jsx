  ...
  return (
    <AnimatedSection id="contact" className="py-32 section-alt relative overflow-hidden">
      ...
      <div className="max-w-[700px] mx-auto px-6 md:px-10 relative z-10">
        ...
        {/* Second Rotating 3D Crystal / Hologram Element at the bottom */}
        <div className="mb-12 p-4 rounded-2xl bg-white/[0.02] border border-white/[0.06] backdrop-blur-md relative overflow-hidden">
          <div className="absolute top-2 left-4 text-[0.65rem] font-mono text-accent/60 uppercase tracking-widest">
        ...
        <div className="p-[1px] rounded-2xl bg-gradient-to-r from-accent/50 via-white/20 to-accent/50 animate-gradient-border shadow-2xl">
