    ...
    translation: {
      ...
      projects: {
        ...
        list: [
          ...
          {
            title: "Telesseg — Aplicação Web",
            desc: "Aplicação web desenvolvida para atendimento e portabilidade de soluções, com foco em usabilidade e experiência do usuário.",
            stack: ["Frontend", "Web", "Usabilidade", "UX"],
            status: "Projeto pessoal",
            repo: null,
        ...
        improvementIdeas: [
          ...
          "Botão de WhatsApp com mensagem pré-definida e link dinâmico",
          "Link direto para LinkedIn e GitHub",
          "Indicador de disponibilidade (online/offline) para agendamentos",
          "mini-mapa ou carteira com links para prova de trabalho (GitHub, LinkedIn)",
          "Campo de nome/assunto com validação e feedback visual",
          "Dark mode toggle na seção de contato para alinhamento visual com o restante do site",
        ],
      },
      certifications: {
        label: "Formação",
    ...
    translation: {
      ...
      projects: {
        ...
        list: [
          ...
          {
            title: "Telesseg — Web Application",
            desc: "Web application developed for service and portability of solutions, focused on usability and user experience.",
            stack: ["Frontend", "Web", "Usability", "UX"],
        ...
        improvementIdeas: [
          ...
          "WhatsApp button with predefined message and dynamic link",
          "Direct link to LinkedIn and GitHub profile",
          "Availability indicator (online/offline) for scheduling",
          "Mini-portfolio with links to work proof (GitHub, LinkedIn)",
          "Name/subject field with validation and visual feedback",
          "Dark mode toggle in contact section to align with the rest of the site",
        ],
      },
      certifications: {
        label: "Education",
