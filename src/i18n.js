  ...
  pt: {
    translation: {
      ...
      hero: {
        ...
        subtitle:
          'Desenvolvedor em formação com experiência em suporte técnico, automação Python e sistemas que resolvem problemas reais.',
        description:
          'Estou em transição de suporte para desenvolvimento e busco minha primeira oportunidade como programador júnior.',
      ...
      experience: {
        ...
        intro:
          'Antes de buscar minha primeira vaga como desenvolvedor, passei por suporte técnico, infraestrutura e automação. Essa vivência me ajuda a entender o usuário final, não só o código.',
        list: [
          {
  ...
  en: {
    translation: {
      ...
      hero: {
        ...
        title1: 'Jefferson Teles',
        subtitle:
          'Developer in transition from technical support, focused on Python automation and web systems that solve real problems.',
      ...
      experience: {
        ...
        intro:
          'Before looking for my first developer role, I worked in technical support, infrastructure and automation. That background helps me understand the end user, not just the code.',
        list: [
          {
